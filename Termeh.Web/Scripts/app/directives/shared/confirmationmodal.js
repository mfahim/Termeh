...
(function () {
    ...
    app.directive('confirmationModal', function () {
        return {
            ...
            template: '<a href="javascript:;"><i class="trash icon"></i></a><div class="ui small modal" id="modal">' +
                        '<div class="header">{{title}}</div><div class="content"><div class="left"> Content can appear on left</div><div class="right">' +
